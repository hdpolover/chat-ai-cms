# add_bot_datasets_relationship_table

# revision identifiers, used by Alembic.
revision = 'ae247a1df74e'
down_revision = 'fe3b4e5d01aa'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('bot_id', 'dataset_id', name='uq_bot_dataset')
    )
    op.create_index('idx_bot_datasets_bot_id', 'bot_datasets', ['bot_id'], unique=False)
    op.create_index('idx_bot_datasets_dataset_id', 'bot_datasets', ['dataset_id'], unique=False)
    ...
    op.alter_column('scopes', 'is_active',
               ...
               server_default=None,
               existing_nullable=False)
    op.alter_column('tenant_ai_providers', 'global_ai_provider_id',
...
def downgrade() -> None:
    ...
    op.drop_index('idx_bot_datasets_dataset_id', table_name='bot_datasets')
    op.drop_index('idx_bot_datasets_bot_id', table_name='bot_datasets')
    op.drop_table('bot_datasets')
    # ### end Alembic commands ###